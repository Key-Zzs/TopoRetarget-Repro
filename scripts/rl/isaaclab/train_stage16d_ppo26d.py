...
def main() -> int:
    ...
    try:
        ...
        # SimulationApp shutdown may spin indefinitely after a constructor or
        # runtime failure.  Let process teardown release Isaac/PhysX resources
        # so the original exception reaches the fail-closed parent promptly.
