...
def render_clip_html(
    *,
    ...
    dataset_name = str(sequence.metadata.dataset_name)
    source_label = "source MANO" if dataset_name.lower() == "grab" else "source hand"
    ...
    payload = {
        ...
        "title": f"{dataset_name.upper()} {clip.robot} quality · {clip.unit_id} · {clip.sequence}",
        "clip": clip.as_dict(),
