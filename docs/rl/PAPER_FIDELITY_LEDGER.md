...
| C.3 semantic qualification | not specified | C3-0 frame target and contact readout validate; Path A condition-gated and finite virtual 3P+3R actuator fails both clips | ENGINEERING_DIAGNOSTIC | C3R2 local closeout bundle |
